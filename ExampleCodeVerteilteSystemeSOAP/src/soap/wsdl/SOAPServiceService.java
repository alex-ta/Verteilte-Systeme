 ...
 * 
 */
@WebServiceClient(name = "SOAPServiceService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://soap/", "SOAPServiceService");
    ...
    public SOAPSERVICE getSOAPSERVICEPort() {
        return super.getPort(new QName("http://soap/", "SOAPSERVICEPort"), SOAPSERVICE.class);
    }
    ...
    public SOAPSERVICE getSOAPSERVICEPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "SOAPSERVICEPort"), SOAPSERVICE.class, features);
    }
